...
Most customers who don't book immediately are NOT gone — they're just:
- Waiting to see if they'll get a better price
- Busy and forgot to call back
- Slightly unsure and just need a nudge

A single follow-up text **within 24 hours** recovers 20–30% of those "lost" leads.

---

## Script 1 — Initial Text After a Call (No Quote Yet)
...
## Script 2 — Quote Sent, No Response After 24 Hours
...
## Script 3 — "Let Me Think About It" Follow-Up
...
## Script 4 — Facebook/Nextdoor Comment Follow-Up
...
## Script 5 — Re-Engage a Cold Lead (2+ Weeks No Response)
...
## Script 6 — After the Job (Review Request)

*Send 1–2 hours after completing the job.*

```
Hey [Name], it was great working with you today! Really glad we could help get that space cleared out 💪
...
## Script 7 — Seasonal Re-Engagement (Past Customers)
...
Also — if you know anyone who could use our help, we'd love the referral! 

📞 (909) 373-5516 | Eliminate Junk Removal
```

---

## Script 8 — Realtor / Property Manager Outreach
...
## Phone Call Script — Incoming Leads
...
"Okay great — that sounds like something we can definitely take care of. Can you send me a quick photo or two of what you've got? That way I can give you an exact flat-rate price right now."

[After seeing photo]

"Alright, for what you've got there, I'd be looking at [$X]. That includes everything — we load it, haul it, and sweep up. Sound good?"

[If they hesitate]
"I totally understand. No pressure at all. Is it the price, or the timing, or something else I can help with?"

[Close]
"Great! I've got [day/time] available — does that work for you? I'll send you a confirmation text right now."
```

---

## Call/Text Response Time — The Golden Rule
...
Keep a simple list (Notes app, spreadsheet, or whiteboard) with:

| Name | Contact | What They Need | Last Follow-Up | Status |
|---|---|---|---|---|
| Maria | (909) xxx-xxxx | Garage cleanout | Mon — sent quote | Waiting |
| John | FB DM | Couch removal | Tue — quote | Booked ✅ |

Review this list every morning and evening. No lead should go more than 48 hours without a follow-up.
